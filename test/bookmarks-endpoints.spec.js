...
describe('Bookmarks endpoints', () => {
    ...
    afterEach('restore the bookmarks', () => {
        // restore the bookmarks to original
    ...
    describe('Unauthorized requests', () => {
        ...
        it('responds with 401 unauthorized for POST /bookmarks', () => {
            return supertest(app)
            .post('/bookmarks')
            .send({ title: 'test-title', url: 'http://examplesite.com', rating: 1 })
            .expect(401, { error: 'Unauthorized request' })
        });
    ...
    describe('DELETE /bookmarks/:id', () => {
        ...
        it('returns 404 when bookmark does not exist', () => {
            return supertest(app)
    ...
    describe('POST /bookmarks', () => {
        it('responds with missing title if not supplied', () => {
        ...
        it('responds with 400 invalid url if not a valid url', () => {
            ...
            .set('Authorization', `Bearer ${process.env.API_TOKEN}`)
            .expect(400, `Must supply a valid URL`)
        });
